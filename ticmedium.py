...
def select_pos():
    if positions[0]== positions[1] and positions[2]== ' ':
        x=2
    elif positions[1] == positions[2] and positions[0] == ' ':
        x=0
    elif positions[0] == positions[2] and positions[1] == ' ':
        x=1
    elif positions[3] == positions[4] and positions[5] == ' ':
        x=5
    elif positions[4] == positions[5] and positions[3] == ' ':
        x=3
    elif positions[3] == positions[5] and positions[4] == ' ':
        x=4
    elif positions[6] == positions[7] and positions[8] == ' ':
        x=8
    elif positions[6] == positions[8] and positions[7] == ' ':
        x=7
    elif positions[7] == positions[8] and positions[6] == ' ':
        x=6
    else:
        turn=0
